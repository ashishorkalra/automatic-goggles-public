...
def test_model_imports():
    ...
    try:
        sys.path.insert(0, '.')
        from transtype.models import TranscriptInput, FieldDefinition, Message, FieldResult, TranscriptOutput
        ...
        print(f"✓ Validated {len(validated.messages)} messages and {len(validated.fields)} fields")
